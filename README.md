...
- User Login Credentials: (arsh/arsh)
...
insert into users values('arsh','arsh','arsh','Arsh','Punjab','1236547089','arsh@gmail.com',2);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/dhaliwalarsh49/onlinebookstore.git```> Select master Branch > Next > Next > Finish.
...
Step 8: The default Username And Password For User Is "arsh" And "arsh"
